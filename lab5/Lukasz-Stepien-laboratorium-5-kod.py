...
plt.grid(True)
plt.savefig("lab5/pictures/Błąd względny ekstrapolacji dla roku 1990", dpi=400)
plt.show()
...
plt.grid(True)
plt.savefig("lab5/pictures/Wartosc AIC_c dla danego modelu aproksymacyjnego", dpi=400)
plt.show()
...
plt.grid(True)
plt.savefig("lab5/pictures/Aproksymacja ciągła funkcji f(x) za pomocą wielomianu Czebyszewa (metoda aproksymacji ortogonalnej)", dpi=400)
plt.show()
