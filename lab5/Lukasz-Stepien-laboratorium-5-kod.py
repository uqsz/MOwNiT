...
populacja = np.array([76212168, 92228496, 106021537, 123202624, 132164569, 151325798, 179323175, 203302031, 226542199])
...
for i in range(0,7):
    print("{:^8} {:^7} {:^20}".format(i, ["{:.2%}".format(x) for x in result1][i], round(result2[i],2)))
...
plt.grid(True)
plt.savefig("pictures/Aproksymacja funkcji sqrt(x) wielomianem Czebyszewa",dpi=400)
